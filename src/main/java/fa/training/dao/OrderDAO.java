...
public class OrderDAO {
    ...
    public int create(Order order) throws SQLException {
        ...
        try{
            ...
            String sql = "INSERT INTO `orders`(`order_date`, `customer_id`, `order_id`, `total`) VALUES ('?',?,?,?)";
    ...
    private int updateDate(int order_id, int customer_id, int employee_id, double total) throws SQLException{
        Connection conn = database.getConn();
        int count = 0;
    ...
    private int delete(int order_id) throws SQLException{
        Connection conn = database.getConn();
        int count;
